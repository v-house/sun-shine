...
const testimonials: string | any[] = [
  {
    ...
    text: "In ac turpis justo. Vivamus auctor quam vitae odio feugiat pulvinar. Sed semper ligula sed lorem tincidunt dignissim. Nam sed cursus lectus.",
  },
  {
    name: "John Doe",
    occupation: "Web Developer",
    text: "Maecenas auctor, quam eget tincidunt pretium, felis diam semper turpis, sed scelerisque diam libero facilisis libero. Quisque vitae semper metus.",
  },
  {
    name: "Anna Deynah",
    occupation: "UX Designer",
    text: "Duis sagittis, turpis in ullamcorper venenatis, ligula nibh porta dui, sit amet rutrum enim massa in ante. Curabitur in justo at lorem laoreet ultricies.",
  },
];
        ...
        <section className="mb-32 text-center">
          ...
          <div className="mx-auto max-w-3xl">
            <div className="bg-blue-900 p-4 rounded-lg text-white">
              <img
                className="mx-auto mb-6 rounded-full shadow-lg w-24 h-24"
              ...
              <p className="mb-6 text-gray-300">{currentTestimonial.text}</p>
            </div>
            <div className="mt-4 flex justify-between">
              <button
                className="text-white text-lg hover:text-blue-500 focus:outline-none"
                onClick={handlePrev}
              >
                Previous
              </button>
              <button
                className="text-blue-500 text-lg hover:text-blue-900 focus:outline-none"
                onClick={handleNext}
              >
                Next
              </button>
